...
class LogisticRegSGD(object):
    ...
    def _compute_gradient(self, errors, feature): 
    ...
    seed=None):
        ...
        for itr in range(maxiter):
            ...
            predictions = self.predict_proba(X[i:i+batch_size, :], weights)
            ...
            for j in range(len(weights)): # loop over each coefficient
                ...
                derivative = self._compute_gradient(errors, X[i:i+batch_size, j])
